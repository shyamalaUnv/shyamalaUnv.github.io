...
// import { ChoicesWrapper } from './ChoicesWrapper.js'

const Field = Formio.Components.components.field;
const getRandomComponentId =  FormioUtils.getRandomComponentId
const boolValue =  FormioUtils.boolValue

// jQuery
// $.getScript('./ChoicesWrapper.js', function()
// {
...
class SelectComponent extends Field {
  ...
  init() {
    ...
    if(id){
    $(this).find(id).append("<div class='barcode-icon'><i class='fa fa-barcode'></i></div>")
    // $(this).append("<div class='barcode-icon'><i class='fa fa-barcode'></i></div>")

    }
  });
   // $(document).ready(function() {
   //   console.log("id $(document).ready = "+$(this)[0].id);
   //       // $('.dropdown').append("<div class='barcode-icon'><i class='fa fa-barcode'></i></div>")
   //       $('#formio').find('#eu88wum').append("<div class='barcode-icon'><i class='fa fa-barcode'></i></div>")
   //  });
  }
  ...
  attach(element) {
   ...
   $(document).off().on('click', '.barcode-icon', (event) => {
        alert("barcode clicked");
          console.log("event.currentTarget.offsetParent.firstElementChild.id = "+event.currentTarget.offsetParent.firstElementChild.id)
    ...
    // this.addEventListener(input, 'openBarcode', (e) => {
    //     let cars = ["Saab", "Volvo", "BMW"];
    //   form.getComponentById(e.detail.controlId).setValue(cars);
